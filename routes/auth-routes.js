...
router.post('/api/resetpassword', async (req, res) => {
    ...
    const resetUrl = `http://${req.headers.host}/reset-password-confirmation/${resetToken}/${email}`;
...
router.get('/reset-password-confirmation/:resetToken/:email', (req, res) => {
    devAuthRLog('handle : /reset-password-confirmation?resetToken=', req.params.resetToken, 'email=', req.params.email);
